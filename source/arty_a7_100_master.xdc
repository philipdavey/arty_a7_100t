...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { fpga_clk_100_mhz }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { fpga_rst_n }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
